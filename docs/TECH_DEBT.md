...
| TD-07 | 错误目录清理 | 2026-03-05 | 清理错误目录和统一命名 |
| TD-08 | 命名统一 | 2026-03-05 | pdmaas → ddp |
| TD-09 | 多人实时编辑 | 2026-03-05 | Yjs CRDT 集成实现 |
| TD-10 | 权限系统 | 2026-03-05 | 三级权限模型 |
| TD-11 | Web 版骨架 | 2026-03-05 | qiankun 微前端框架 |
| TD-12 | 数据标准 API | 2026-03-05 | DataItem/CodeValue CRUD |
| TD-13 | API 文档 | 2026-03-07 | 请求/响应示例完整 |
| TD-14 | 代码注释 | 2026-03-07 | AuthController Javadoc 完善 |
| TD-15 | 开发指南 | 2026-03-07 | PROJECT_PLAN.md 新建 |
| TD-16 | 单元测试 | 2026-03-07 | shared-ui 测试文件新增 |
...
| TD-22 | shared-ui 包 | 2026-03-07 | 公共组件库新增（9 组件 + 5 hooks + 8 工具） |
| TD-23 | Web-EE 页面 | 2026-03-07 | 7 个完整页面（Dashboard/Designer/Team/等） |
